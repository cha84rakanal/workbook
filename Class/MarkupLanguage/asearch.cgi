...
xslt.xsl = "author_search.xsl"
keyw = ""

if cgi.include?('author') then
  keyw = cgi["author"]
end
xslt.parameters = { "author" => keyw }
out = xslt.serve()
    ...
    window.onload = () => {
      ...
      for (let i = 0; i < rows.length; i++) {
        ...
        let createClickHandler = (row) => {
          return () => {
            let id = row.getElementsByTagName("td")[0].innerHTML.substring(0,24);
            miframe.src="http://cgi.u.tsukuba.ac.jp/~s1611468/files/adetail.cgi?akey="+id;
            dialog.showModal();
          };
        };
        ...
        <div class="demo-container mdl-grid">
          ...
          <div class="demo-content mdl-color--white mdl-shadow--4dp content mdl-color-text--grey-800 mdl-cell mdl-cell--8-col">
            ...
            <div class="mdl-grid">
              ...
              <form method="post" action="asearch.cgi">
              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <input class="mdl-textfield__input" type="text" id="key1" name="author">
                <label class="mdl-textfield__label" for="key1">著者名...</label>
              </div>
...
print <<EOS
    ...
    <dialog id="dialog_selector" class="mdl-dialog" style="position: absolute;width:80%">
        <h4 class="mdl-dialog__title">著者詳細</h4>
